...
|_______________________|
        ...
        log_filename = _jp('CRISPRessoPooled_STEP2_RUNNING_LOG.txt')
        logger.addHandler(logging.FileHandler(log_filename))
        logger.addHandler(CRISPRessoShared.StatusHandler(_jp('CRISPRessoPooled_STEP2_status.txt')))
        ...
        if RUNNING_MODE=='ONLY_GENOME' or RUNNING_MODE=='AMPLICONS_AND_GENOME':
            ...
            with open(REPORT_ALL_DEPTH, 'w') as f:
                ...
                for chr_output_filename in glob.glob(MAPPED_REGIONS+'*info'):
